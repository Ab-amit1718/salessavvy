...
public class OrderService {
    ...
    public Map<String, Object> createOrder(User user, CreateOrderRequest request) {
        ...
        orderRepository.save(order); // cascades orderItems
    ...
    public Map<String, Object> getUserOrders(User user) {
        ...
        for (Order order : orders) {
            ...
            for (OrderItem item : order.getOrderItems()) {
                ...
                itemData.put("name", product != null ? product.getName() : null);
                itemData.put("quantity", item.getQuantity());
                itemData.put("price", item.getPricePerUnit());
 ...
 // ============================
 // INTERNAL: MARK ORDER STATUS
 // ============================
 public void markOrderStatus(String orderId, OrderStatus status) {
